...
import com.example.sql.data.PetProvider;
...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Editor activity","url"+currentPetUri);
        ...
        if (currentPetUri==null)
        {
        ...
        else
            {
                ...
                mBreedEditText.setText(bundle.getString("breed"));
                mWeightEditText.setText(bundle.getString("weight"));
    ...
    private void showUnsaveDialogChanges(
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                showUnsaveDialogChanges(discardButtonClickListener);
                return true;
